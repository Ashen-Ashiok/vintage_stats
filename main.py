...
from vintage_stats.data_processing import get_stack_wl, get_last_matches_map, log_requests_count, \
    ...
    get_hero_name, \
    save_player_match_history, handle_recent_matches_file, check_victory, update_player_match_history, get_match_history_difference
...
def main():
    if args.monitor:
        ...
        for player in vintage_small:
            ...
            match_id_to_match_listing, common_history_point = \
                get_match_history_difference(player, recent_matches, match_history, match_id_to_match_listing)

            update_player_match_history(player, recent_matches, match_history, common_history_point)
        ...
        logging.info(f"Monitor run finished.")
    ...
    if args.monitor_old:
        ...
        for player in last_matches_map:
            ...
            print(f"**{player}** played a {solo_string}{game_mode_string} game as **{match['player_hero']}**, "
